        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "business_name",
                    models.CharField(
                        max_length=200, null=True, verbose_name="Business Name"
                    ),
                ),
                ("website_url", models.URLField(max_length=2000, null=True)),
                (
                    "phone_number",
                    models.CharField(max_length=200, verbose_name="phone_number"),
                ),
                ("address", models.CharField(max_length=200, verbose_name="Address")),
                ("city", models.CharField(max_length=200, verbose_name="Address")),
                (
                    "is_partner",
